...
public interface PublisherResource {
	...
	@ResponseBody
	@GetMapping("/")
	List<PublisherDTO> getPublisher(@RequestBody Pageable pageable);
	...
	List<PublisherDTO> getPublishers(@PathVariable("name") String name, @RequestBody Pageable pageable);
